...
namespace SalesWebMvc.Controllers
{
    public class DepartamentosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,DataCadastro")] Departamentos departamentos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,DataCadastro")] Departamentos departamentos)
        {
